...
function HomePage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* Hero Section with Carousel */}
      <div className="relative h-[80vh]"> {/* Increased height for hero section */}
        <Carousel
          autoPlay
          infiniteLoop
          interval={5000}
        ...
        >
          {[
            { img: background1, text: "Explore Mountains" },
            { img: background2, text: "Discover Cities" },
            { img: background3, text: "Relax at Beaches" }
          ].map((slide, index) => (
...
{/* Search Form Overlay */}
      ...
      >
        ...
        <div className="flex flex-col w-full max-w-sm space-y-4"> {/* Reduced width */}
          <input
            type="text"
